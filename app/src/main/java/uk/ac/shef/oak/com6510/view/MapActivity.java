...
public class MapActivity extends AppCompatActivity {
    ...
    private void onPhotosReturned(@NonNull MediaFile[] returnedPhotos) {
        ...
        String name = setImageName();
        photo.setName(name);
        String date = name.substring(5,8)
                +"/"+name.substring(9,10)
                +"/"+name.substring(11,12);
        String time = name.substring(14,15)
                +":"+name.substring(16,17);
        photo.setDate(date);
        photo.setTime(time);
        ...
        Log.e("date", date);
        Log.e("name", name);
        Log.e("temperature", photo.getTemperature());
        Log.e("pressure", photo.getPressure());
